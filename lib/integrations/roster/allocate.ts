...
const baseUrl = process.env.ALLOCATE_API_BASE_URL || "";
const token = process.env.ALLOCATE_API_TOKEN || "";
const sqlQuery = process.env.AZURE_SQL_ROSTER_SHIFTS_QUERY || "";

export const allocateConnector: RosterConnector = {
  id: "allocate",
  name: "Allocate",
  async getStatus(): Promise<ConnectorStatus> {
    ...
    return {
      ...
      lastSync: null,
      error: connected ? null : "Allocate sandbox not configured",
    };
  },
  async getShifts() {
