...
const baseUrl = process.env.HEALTHROSTER_API_BASE_URL || "";
const token = process.env.HEALTHROSTER_API_TOKEN || "";
const sqlQuery = process.env.AZURE_SQL_ROSTER_SHIFTS_QUERY || "";

export const healthRosterConnector: RosterConnector = {
  id: "healthroster",
  ...
  async getStatus(): Promise<ConnectorStatus> {
    ...
    return {
      ...
      lastSync: null,
      error: connected ? null : "HealthRoster sandbox not configured",
    };
  },
  async getShifts() {
